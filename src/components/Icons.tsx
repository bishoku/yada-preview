...
export const FullscreenIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const SpinnerIcon: React.FC<IconProps> = ({ size = 16, ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
    ...
    strokeLinejoin="round"
    xmlns="http://www.w3.org/2000/svg"
    style={{ animation: 'yada-spin 1s linear infinite', ...props.style }}
    {...props}
  >
